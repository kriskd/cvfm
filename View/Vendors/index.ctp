...
<?php if ($noVendors): ?>
    <p>Coming soon...</p>
<?php endif; ?>
<p><?php echo $this->Html->link('2016 Vendor Application', '/files/CVFM2016Application.pdf'); ?></p>
<p><?php echo $this->Html->link('2016 Vendor Rules and Bylaws', '/files/CVFM2016RulesAndByLaws.pdf'); ?></p>
